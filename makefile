scheduler: calendar.o log.o db.o tool.o screen.o screenobject.o menu.o addtaskpanel.o looping.o main.o
	g++ -std=c++17 -g calendar.o log.o db.o tool.o screen.o screenobject.o menu.o addtaskpanel.o looping.o main.o -lncurses -lsqlite3 -o scheduler
...
calendar.o: ./sources/calendar.cpp
	g++ -std=c++17 -g -c ./sources/calendar.cpp -lncurses
